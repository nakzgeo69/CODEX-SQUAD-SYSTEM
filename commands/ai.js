...
module.exports = {
  ...
  description: 'Text-based AI assistant with conversation support',
  ...
  async callAPI(prompt, senderId) {
    const apiConfigs = [
      // PRIMARY: Cedds DeepChat (Complete answers!)
      {
        name: 'Cedds DeepChat',
  ...
  extractResponse(data, config) {
    // Try the configured response path first
