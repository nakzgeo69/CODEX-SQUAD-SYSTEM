...
module.exports = {
  ...
  buildFinalPrompt(prompt, previousResponse, isReply) {
    ...
    if (isReply && previousResponse) {
      ...
      if (this.isTranslationRequest(prompt)) {
      ...
      } else if (lowerPrompt.includes('elaborate') || lowerPrompt.includes('explain') || 
                 lowerPrompt.includes('paki elaborate') || lowerPrompt.includes('explain it well') ||
                 lowerPrompt.includes('detail') || lowerPrompt.includes('further')) {
        ...
        finalPrompt += 'User wants a summary of your previous response.\n';
        finalPrompt += 'Provide a concise summary with only the key points.\n\n';
        ...
        finalPrompt += 'Provide a direct and relevant response.\n\n';
      }
    } else {
      finalPrompt = prompt;
    }
  ...
  isTranslationRequest(prompt) {
    const keywords = [
      ...
      'japanese', 'nihongo', 'korean', 'hangeul', 'french', 'francais',
      'german', 'deutsch', 'italian', 'italiano', 'portuguese', 
      'russian', 'arabic', 'hindi', 'urdu', 'bengali', 'tamil',
      'telugu', 'marathi', 'gujarati', 'kannada', 'malayalam',
      'thai', 'vietnamese', 'indonesian', 'malay', 'burmese',
      'khmer', 'lao', 'nepali', 'sinhala', 'armenian',
      'hebrew', 'greek', 'latin', 'dutch', 'swedish', 
