...
module.exports = {
  ...
  description: 'Complete AI assistant with proper problem solving format',
  usage: 'ai [question]',
  version: '4.3.0',
  author: 'codex',
  category: 'AI',
  ...
  async execute(senderId, args, token, event) {
    try {
      ...
      // Clean math/problem solving responses
